...
class HeadingReporter:
    ...
    def _report_context(self):
        ...
        print('column_separator_for_lhs: {}'.format(self.cxt.display_string_for_column_separator(self.cxt.column_separator_for_lhs)))   # DONE: タブのときの表示
        print('column_separator_for_rhs: {}'.format(self.cxt.display_string_for_column_separator(self.cxt.column_separator_for_rhs)))   # DONE: タブのときの表示
...
class LhsFact:
    ...
    def __init__(self, lhs_row_number, lhs_row, lhs_key):
        ...
        logger.debug('LhsFact 生成 lhs_row_number={}, lhs_row={}, lhs_key={}'.format(lhs_row_number, lhs_row, lhs_key))
...
class RhsFact:
    ...
    def __init__(self, rhs_row_number, rhs_row, rhs_key):
        ...
        logger.debug('RhsFact 生成 rhs_row_number={}, rhs_row={}, rhs_key={}'.format(rhs_row_number, rhs_row, rhs_key))
...
class CsvReader:
    ...
    def __init__(self, lhs_csv, rhs_csv, lhs_dialect, rhs_dialect, context):
        ...
        debug_log_dialect(lhs_dialect, context, '左CSV')
        debug_log_dialect(rhs_dialect, context, '右CSV')
